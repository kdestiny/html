	   ...
	   <div class="wp cl">
			<!--{hook/global_cpnav_top}-->
				...
				<div class="right_menu y">	
					...
					<!--{template common/h2o_userstatus}-->

					<!--{if $_G['uid'] && !empty($_G['style']['extstyle'])}--><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});" class="h2o_ps y">配色</a><!--{/if}-->
...
<div class="h2o_nav wp cl">
	...
	<div class="h2o_ad_logo"> 
		<!--{if !isset($_G['setting']['navlogos'][$mnid])}--><a href="{if $_G['setting']['domain']['app']['default']}http://{$_G['setting']['domain']['app']['default']}/{else}./{/if}" title="$_G['setting']['bbname']">{$_G['style']['boardlogo']}<small></small></a><!--{else}-->$_G['setting']['navlogos'][$mnid]<!--{/if}-->
	</div>
