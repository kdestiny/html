...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript" src="$_G['style'][styleimgdir]/js/pic_chages.js"></script>

    <script type="text/javascript" src="$_G['style'][styleimgdir]/js/main.js"></script>
	<script>setTimeout("echo.init({offset:8,throttle:0})",160);</script>
	<script type="text/javascript" src="$_G['style'][styleimgdir]/js/bootstrap.min.js"></script>
