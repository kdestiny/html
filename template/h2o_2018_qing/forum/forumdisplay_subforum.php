...
<div class="bm bmw box fl{if $_G['forum']['forumcolumns']} flg{/if}" style="margin-bottom: 16px;">
	<div class="bm_h cl" style=" margin: 0; padding: 0;height: 45px;line-height: 45px;border-bottom: 1px solid #E7E8EB !important;border-top: 0;background: #fff;text-indent: 12px;;font-size: 16px;color: #757575;overflow: hidden;">
		<span class="o"><img id="subforum_{$_G[forum][fid]}_img" src="{IMGDIR}/$collapseimg[subforum]" title="{lang spread}" alt="{lang spread}" onclick="toggle_collapse('subforum_$_G['forum'][fid]');" style=" margin: 18px 20px 0 0;" /></span>
		<h2 style="font-size: 18px; color: #555;font-weight: 400;">{lang forum_subforums}</h2>
	</div>
