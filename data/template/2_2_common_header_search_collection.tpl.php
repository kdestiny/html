...
0
|| checktplrefresh('./template/h2o_2018_qing/common/header.htm', './template/h2o_2018_qing/common/header_common.htm', 1551689453, '2', './data/template/2_2_common_header_search_collection.tpl.php', './template/h2o_2018_qing', 'common/header_search_collection')
|| checktplrefresh('./template/h2o_2018_qing/common/header.htm', './template/h2o_2018_qing/common/header_qmenu.htm', 1551689453, '2', './data/template/2_2_common_header_search_collection.tpl.php', './template/h2o_2018_qing', 'common/header_search_collection')
;?>
...
<div class="left_menu z"><?php if(is_array($_G['setting']['topnavs']['0'])) foreach($_G['setting']['topnavs']['0'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } if(is_array($_G['setting']['topnavs']['1'])) foreach($_G['setting']['topnavs']['1'] as $nav) { if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><?php echo $nav['code'];?><?php } } ?>	
...
<div class="right_menu y"><?php include template('common/h2o_userstatus'); if($_G['uid'] && !empty($_G['style']['extstyle'])) { ?><a id="sslct" href="javascript:;" onmouseover="delayShow(this, function() {showMenu({'ctrlid':'sslct','pos':'34!'})});" class="h2o_ps y">配色</a><?php } ?>

</div>	

</div>
  </div><?php echo adshow("headerbanner/wp a_h");?><?php if(!IS_ROBOT) { if($_G['uid']) { ?>
...
<div class="h2o_nav wp cl"><?php $mnid = getcurrentnav();?><div class="h2o_ad_logo"> 
<?php if(!isset($_G['setting']['navlogos'][$mnid])) { ?><a href="<?php if($_G['setting']['domain']['app']['default']) { ?>http://<?php echo $_G['setting']['domain']['app']['default'];?>/<?php } else { ?>./<?php } ?>" title="<?php echo $_G['setting']['bbname'];?>"><?php echo $_G['style']['boardlogo'];?><small></small></a><?php } else { ?><?php echo $_G['setting']['navlogos'][$mnid];?><?php } ?>
</div>

    <div class="h2o_nv z">
        <ul><?php if(is_array($_G['setting']['navs'])) foreach($_G['setting']['navs'] as $nav) { ?> <?php if($nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?><li <?php if($mnid == $nav['navid']) { ?>class="a" <?php } ?><?php echo $nav['nav'];?>></li><?php } } ?>
</ul>	
<?php if(!empty($_G['setting']['pluginhooks']['global_nav_extra'])) echo $_G['setting']['pluginhooks']['global_nav_extra'];?>		
</div><?php include template('common/pubsearchform'); ?></div>
...
<?php echo $_G['setting']['menunavs'];?><?php echo adshow("subnavbanner/a_mu");?></div>
</div>
