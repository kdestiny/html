...
0
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/userabout.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_header.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/seditor.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/upload.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/common/seccheck.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/follow_feed_li.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_userabout.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/h2o_2018_qing/common/header_common.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_diy.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
|| checktplrefresh('./template/default/home/follow_feed.htm', './template/default/home/space_header_personalnv.htm', 1550926359, 'diy', './data/template/2_diy_home_follow_feed.tpl.php', './template/h2o_2018_qing', 'home/follow_feed')
;?>
...
<base href="<?php echo $_G['siteurl'];?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_2_common.css?<?php echo VERHASH;?>" /><link rel="stylesheet" type="text/css" href="data/cache/style_2_home_follow.css?<?php echo VERHASH;?>" /><?php if($_G['uid'] && isset($_G['cookie']['extstyle']) && strpos($_G['cookie']['extstyle'], TPLDIR) !== false) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['cookie']['extstyle'];?>/style.css" /><?php } elseif($_G['style']['defaultextstyle']) { ?><link rel="stylesheet" id="css_extstyle" type="text/css" href="<?php echo $_G['style']['defaultextstyle'];?>/style.css" /><?php } ?><script src="<?php echo $_G['style']['styleimgdir'];?>/js/jquery-1.10.2.min.js" type="text/javascript"></script>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/pic_chages.js" type="text/javascript"></script>

    <script src="<?php echo $_G['style']['styleimgdir'];?>/js/main.js" type="text/javascript"></script>
<script>setTimeout("echo.init({offset:8,throttle:0})",160);</script>
<script src="<?php echo $_G['style']['styleimgdir'];?>/js/bootstrap.min.js" type="text/javascript"></script>
...
<?php if(empty($_GET['diy'])) { $_GET['diy'] = '';?><?php } if(!isset($topic)) { $topic = array();?><?php } $todayposts = DB::result_first("SELECT sum(todayposts) FROM ".DB::table('forum_forum')." WHERE status=1");?>    <?php $yesterdayposts = DB::result_first("SELECT sum(yesterdayposts) FROM ".DB::table('forum_forum')." WHERE status=1");?><script src="<?php echo $_G['setting']['jspath'];?>home.js?<?php echo VERHASH;?>" type="text/javascript"></script>
