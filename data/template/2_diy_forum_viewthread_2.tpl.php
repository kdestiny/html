<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('viewthread_2');
0
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/h2o_2018_qing/forum/viewthread_node.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/h2o_2018_qing/forum/viewthread_node.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/h2o_2018_qing/forum/viewthread_fastpost.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/h2o_2018_qing/forum/viewthread_node_body.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/h2o_2018_qing/forum/viewthread_node_body.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/default/common/seditor.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/default/forum/seccheck_post.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/default/common/upload.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/viewthread_2.htm', './template/default/common/seccheck.htm', 1550929834, 'diy', './data/template/2_diy_forum_viewthread_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/viewthread_2')
;
block_get('7,8');?><?php include template('common/header'); ?><link href="template/h2o_2018_qing/common/f_v.css" rel="stylesheet" type="text/css" /><?php $authorlist = C::t('forum_thread')->fetch_all_by_authorid_displayorder($_G[forum_thread][authorid], 0,'>=',  0,  '', 0, 5);?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_top'])) echo $_G['setting']['pluginhooks']['viewthread_top'];?><?php echo adshow("text/wp a_t");?><div id="ct" class="wp cl ct2">
...
<?php if($post['first']) { ?>
<div id="post_<?php echo $post['pid'];?>" class="" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>>
    <div class="viewthead">			   
...
<div id="threadstamp"><img src="<?php echo $_G['style']['styleimgdir'];?>/stamp/<?php echo $_G['forum_threadstamp']['url'];?>" title="<?php echo $_G['forum_threadstamp']['text'];?>" /></div>
<?php } if(empty($post['deleted'])) { ?>

<table id="pid<?php echo $post['pid'];?>" class="plhin boxtable viewbox <?php if($post['first']) { ?>firstfloor<?php } else { ?>otherfloor<?php } ?>" summary="pid<?php echo $post['pid'];?>" cellspacing="0" cellpadding="0">
<tr>
...
<?php } ?>
<div class="h2o_hook_avatar"><?php if(!empty($_G['setting']['pluginhooks']['viewthread_avatar'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_avatar'][$postcount];?></div>
</div>
...
<?php } } else { ?>
            	<div class="avatar"><img src="<?php echo $_G['style']['styleimgdir'];?>/hidden.gif" /></div>
<div class="pi">
                <div class="authi">
...
<div class="authi" style="float: left;"><?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?><?php if($_self ) { ?>
...
<?php if($_G['forum_thread']['typeid'] && $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']]) { if(!IS_ROBOT && ($_G['forum']['threadtypes']['listable'] || $_G['forum']['status'] == 3)) { ?><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=typeid&amp;typeid=<?php echo $_G['forum_thread']['typeid'];?>" class="colorlink">[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]</a><?php } else { ?>[<?php echo $_G['forum']['threadtypes']['types'][$_G['forum_thread']['typeid']];?>]<?php } } if($threadsorts && $_G['forum_thread']['sortid']) { ?><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>&amp;filter=sortid&amp;sortid=<?php echo $_G['forum_thread']['sortid'];?>">[<?php echo $_G['forum']['threadsorts']['types'][$_G['forum_thread']['sortid']];?>]</a><?php } ?><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php echo $fromuid;?>" <?php if($_G['page'] <= 1) { ?>onclick="return copyThreadUrl(this, '<?php echo $_G['setting']['bbname'];?>')"<?php } ?> <?php if($fromuid) { ?>title="您的朋友访问此链接后，您将获得相应的积分奖励"<?php } ?>><span id="thread_subject"><?php echo $_G['forum_thread']['subject'];?></span></a>

<?php if($_G['forum_thread']['recommendlevel']) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/agree.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
<?php } if($thread['digest'] > 0 && $filter != 'digest') { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/digest_1.png" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
        <?php } if($_G['forum_thread']['closed'] == 1) { ?>
<img src="<?php echo $_G['style']['styleimgdir'];?>/folder_lock.gif" align="absmiddle" alt="heatlevel" title="热度: <?php echo $thread['heats'];?>" />
...
<div class="authi <?php if($post['first'] ) { ?>firstauthi<?php } ?>">
                <?php $_self = $thread['author'] && $post['author'] == $thread['author'] && $post['position'] !== '1';?>                <?php if(!$post['first']) { if($_self ) { ?>
<img class="authicn vm" id="authicon<?php echo $post['pid'];?>" src="<?php echo IMGDIR;?>/ico_lz.png" />
<?php } else { if(!$post['anonymous'] && $_G['cache']['groupicon'][$post['groupid']]) { ?>
<img class="authicn vm" id="authicon<?php echo $post['pid'];?>" src="<?php echo $_G['cache']['groupicon'][$post['groupid']];?>" />
<?php } else { ?>
...
<em id="authorposton<?php echo $post['pid'];?>">&nbsp;于&nbsp;<?php echo $post['dateline'];?></em>
<?php if($post['status'] & 8) { ?>
<span class="xg1"><?php if($_G['setting']['mobile']['mobilecomefrom']) { ?><?php echo $_G['setting']['mobile']['mobilecomefrom'];?><?php } else { ?>来自手机<?php } ?></span>
<?php } } elseif(getstatus($post['status'], 5)) { ?>
<a href="javascript:;" class="xi2"><?php echo $post['author'];?></a>
&nbsp;<em id="authorposton<?php echo $post['pid'];?>">发表于 <?php echo $post['dateline'];?></em>
<?php } elseif($post['authorid'] && $post['username'] && $post['anonymous'] || !$post['authorid'] && !$post['username']) { ?>
<?php echo $_G['setting']['anonymoustext'];?>&nbsp;
<em id="authorposton<?php echo $post['pid'];?>">发表于 <?php echo $post['dateline'];?></em>
...
<?php } ?>
 ...
 <span class="none"><img src="<?php echo IMGDIR;?>/arw_r.gif" class="vm" alt="回帖奖励" style=" margin-top: -2px; opacity: 0.75;" /></span>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_postheader'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_postheader'][$postcount];?>
  ...
  <span class="vwthdreplies y"><i class="msg"></i><?php echo $_G['forum_thread']['allreplies'];?></span>
  <span class="vwthdviews y"><i class="see"></i><?php echo $_G['forum_thread']['views'];?></span> 
...
<span class="pipe z" style=" margin: 5px 5px 0 0;">|</span>
         ...
         <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" id="k_favorite" class="k_favorite z" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><span id="favoritenumber"><?php echo $_G['forum_thread']['favtimes'];?></span> 人收藏</a>       
...
<?php if(!$rushreply) { if($ordertype != 1) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=1"  class="show">正序排列</a>
<?php } else { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>&amp;extra=<?php echo $_GET['extra'];?>&amp;ordertype=2"  class="show">倒序排列</a>
<?php } } ?>
</span>
<div class="nonstop">
...
<?php } ?>
           ...
           <?php } else { ?>
    <?php if($postcount == 0) { ?>
<div class="reply_title cl"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?>" class="go_black">返回查看帖子内容</a></div>
<?php } ?>
            <div id="post_<?php echo $post['pid'];?>" class="" <?php if($_G['blockedpids'] && $post['inblacklist']) { ?>style="display:none;"<?php } ?>>
    <div class="viewthead">			   
                    <?php $needhiddenreply = ($hiddenreplies && $_G['uid'] != $post['authorid'] && $_G['uid'] != $_G['forum_thread']['authorid'] && !$post['first'] && !$_G['forum']['ismoderator']);
...
<?php } else { ?>
<div class="avatar avtm"><img src="<?php echo $_G['style']['styleimgdir'];?>/h2o_nologin.png"></div>
<?php } ?>
...
<textarea rows="6" cols="80" name="message" id="fastpostmessage" onkeydown="seditor_ctlent(event, 'fastpostvalidate($(\'fastpostform\'))');" tabindex="4" class="pt h2o_tishi" onblur="(this.value=='')?(this.className='pt h2o_tishi'):(this.className='pt')" onfocus="this.className='pt';"></textarea>
<?php } else { ?>
<div class="pt hm">
...
<div class="h2o-forum-grid"> 
    ...
    <a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" title="<?php echo $_G['forum_thread']['author'];?>" target="_blank"><?php echo avatar($_G[forum_thread][authorid],big);?></a>
        </div>

<div class="h2o-viem-author">			
<div class="authi"><a href="home.php?mod=space&amp;uid=<?php echo $_G['forum_thread']['authorid'];?>" target="_blank" class="xw1"<?php if($_G['forum_thread']['groupcolor']) { ?> style="color: <?php echo $_G['forum_thread']['groupcolor'];?>"<?php } ?>><?php echo $_G['forum_thread']['author'];?></a></div>
    <?php $thread_space=$space = getuserbyuid($_G[forum_thread][authorid], 1);?>    <?php space_merge($thread_space, 'count');?><div class="authortitle"><?php echo $_G['cache']['usergroups'][$thread_space[groupid]][grouptitle];?></div>

    <div class="tns xg2">
<table cellspacing="0" cellpadding="0">
 <tbody>
<tr>
<th><p><a href="home.php?mod=space&amp;uid=1&amp;do=thread&amp;type=thread&amp;view=me&amp;from=space" class="xi2"><?php echo $thread_space[threads];?></a></p>主题</th>
<th><p><a href="home.php?mod=space&amp;uid=1&amp;do=thread&amp;type=reply&amp;view=me&amp;from=space" class="xi2"><?php echo $thread_space[posts];?></a></p>帖子</th>
<td><p><a href="javascript:void(0);" class="xi2"><?php echo $thread_space[credits];?></a></p>积分</td>
</tr>
 </tbody>
</table>
</div><?php $h2o_authorid = $_G['forum_thread']['authorid']; $h2o_medals = DB::fetch_all("SELECT * FROM ".DB::table('common_member_medal')." WHERE `uid`= $h2o_authorid ORDER BY `medalid` ASC");?><?php if($h2o_medals) { ?>
<p class="md_ctrl">
   <a href="home.php?mod=medal"><?php if(is_array($h2o_medals)) foreach($h2o_medals as $h2o_medal) { $h2o_medaltubiao = DB::result(DB::query("SELECT image FROM ".DB::table('forum_medal')." WHERE medalid = '$h2o_medal[medalid]'"));?>      <img src="<?php echo $_G['style']['styleimgdir'];?>/common/<?php echo $h2o_medaltubiao;?>">
<?php } ?>
   </a>
</p>
<?php } ?>
...
<?php if(helper_access::check_module('follow')) { ?>
<a href="home.php?mod=spacecp&amp;ac=follow&amp;op=add&amp;hash=<?php echo FORMHASH;?>&amp;fuid=<?php echo $_G['forum_thread']['authorid'];?>" id="followmod_<?php echo $_G['forum_thread']['authorid'];?>" title="收听TA" class="xi2" onclick="showWindow('followmod', this.href, 'get', 0);" style=" background: #4fc277;width: 120px;color: #fff;">关注Ta</a>
<?php } ?>
<a href="home.php?mod=spacecp&amp;ac=pm&amp;op=showmsg&amp;handlekey=showmsg_<?php echo $_G['forum_thread']['authorid'];?>&amp;touid=<?php echo $_G['forum_thread']['authorid'];?>&amp;pmid=0&amp;daterange=2&amp;pid=<?php echo $_G['forum_thread']['pid'];?>&amp;tid=<?php echo $_G['forum_thread']['tid'];?>" onclick="showWindow('sendpm', this.href);" title="发消息" class="h2o-sendpm" style=" background: #1499f8;width: 120px;color: #fff;">发消息</a>
  </div>
</div>
...
<ul class="cl" style="padding: 19px 19px 0;">
    <?php if(is_array($authorlist)) foreach($authorlist as $value) { ?>    <?php $h2o_ad_pic = substr($value[tid], -1); $threadpic = DB::fetch_all("SELECT * FROM ".DB::table('forum_attachment_'.$h2o_ad_pic.'')." WHERE `tid`= $value[tid] AND isimage = '1' ORDER BY `dateline` DESC limit 0 , 1");?><?php require_once(DISCUZ_ROOT."./source/function/function_post.php");?>    <li>
   <a href="forum.php?mod=viewthread&amp;tid=<?php echo $value['tid'];?>" target="_blank">
 <?php if(is_array($threadpic)) foreach($threadpic as $h2o_ad_pic) { ?>    <?php $piclist = getforumimg($h2o_ad_pic[aid], 0, 270, 180);?>        <div class="h2o-pic-content"><img src="<?php echo $piclist;?>" alt="<?php echo $value['subject'];?>"></div>
<?php } ?>	       	   
<p><?php echo $value['subject'];?></p>
        <p class="des"><?php echo messagecutstr(DB::result_first('SELECT `message` FROM '.DB::table('forum_post').' WHERE `tid` ='.$value['tid'].' AND `first` =1'),80);; ?></p>
...
<div class="h2o_diy_box cl">
<!--[diy=diyforumlisthot]--><div id="diyforumlisthot" class="area"><div id="framexzXdIi" class="cl_frame_bm frame move-span cl frame-1"><div id="framexzXdIi_left" class="column frame-1-c"><div id="framexzXdIi_left_temp" class="move-span temp"></div><?php block_display('7');?></div></div></div><!--[/diy]-->
    </div>

<div class="h2o_diy_box cl">
<!--[diy=diyforumlisthy]--><div id="diyforumlisthy" class="area"><div id="frameIqAjSm" class="cl_frame_bm frame move-span cl frame-1"><div id="frameIqAjSm_left" class="column frame-1-c"><div id="frameIqAjSm_left_temp" class="move-span temp"></div><?php block_display('8');?></div></div></div><!--[/diy]-->
    </div>
