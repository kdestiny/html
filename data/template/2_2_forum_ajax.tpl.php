...
0
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/header_ajax.htm', 1550925891, '2', './data/template/2_2_forum_ajax.tpl.php', './template/h2o_2018_qing', 'forum/ajax')
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/footer_ajax.htm', 1550925891, '2', './data/template/2_2_forum_ajax.tpl.php', './template/h2o_2018_qing', 'forum/ajax')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
