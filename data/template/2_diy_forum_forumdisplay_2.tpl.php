<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forumdisplay_2');
0
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/h2o_2018_qing/forum/forumdisplay_leftside.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/default/forum/recommend.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/default/common/seccheck.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/h2o_2018_qing/forum/forumdisplay_list.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/default/forum/forumdisplay_sort.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/default/forum/search_sortoption.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
|| checktplrefresh('data/diy/./template/h2o_2018_qing//forum/forumdisplay_2.htm', './template/default/forum/search_sortoption.htm', 1550930636, 'diy', './data/template/2_diy_forum_forumdisplay_2.tpl.php', 'data/diy/./template/h2o_2018_qing/', 'forum/forumdisplay_2')
;
block_get('32,31,30');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<div class="h2o_diy_box cl">
<!--[diy=diyforumlisthy]--><div id="diyforumlisthy" class="area"><div id="frameevc44e" class="cl_frame_bm frame move-span cl frame-1"><div id="frameevc44e_left" class="column frame-1-c"><div id="frameevc44e_left_temp" class="move-span temp"></div><?php block_display('32');?></div></div></div><!--[/diy]-->
    </div>

<div class="h2o_diy_box cl">
<!--[diy=diyforumlisthot]--><div id="diyforumlisthot" class="area"><div id="frameh11Mg8" class="cl_frame_bm frame move-span cl frame-1"><div id="frameh11Mg8_left" class="column frame-1-c"><div id="frameh11Mg8_left_temp" class="move-span temp"></div><?php block_display('31');?></div></div></div><!--[/diy]-->
    </div>

<div class="h2o_diy_box cl">
<!--[diy=diyforumlisthd]--><div id="diyforumlisthd" class="area"><div id="frameV3TX2S" class="cl_frame_bm frame move-span cl frame-1"><div id="frameV3TX2S_left" class="column frame-1-c"><div id="frameV3TX2S_left_temp" class="move-span temp"></div><?php block_display('30');?></div></div></div><!--[/diy]-->
    </div>
