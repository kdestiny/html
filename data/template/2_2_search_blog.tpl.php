...
0
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/header.htm', 1551626499, '2', './data/template/2_2_search_blog.tpl.php', './template/h2o_2018_qing', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/pubsearch.htm', 1551626499, '2', './data/template/2_2_search_blog.tpl.php', './template/h2o_2018_qing', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/blog_list.htm', 1551626499, '2', './data/template/2_2_search_blog.tpl.php', './template/h2o_2018_qing', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/default/search/footer.htm', 1551626499, '2', './data/template/2_2_search_blog.tpl.php', './template/h2o_2018_qing', 'search/blog')
|| checktplrefresh('./template/default/search/blog.htm', './template/h2o_2018_qing/common/header_common.htm', 1551626499, '2', './data/template/2_2_search_blog.tpl.php', './template/h2o_2018_qing', 'search/blog')
;?>
...
<?php } ?><?php if(!empty($_G['setting']['pluginhooks']['blog_top'])) echo $_G['setting']['pluginhooks']['blog_top'];?>
...
</div><?php echo adshow("search/y mtw");?><?php if(empty($bloglist)) { ?>
<p class="emp xs2 xg2">对不起，没有找到匹配结果。</p>
<?php } else { ?>
<div class="slst mtw">
<ul><?php if(is_array($bloglist)) foreach($bloglist as $blog) { ?><li class="pbw">
<h3 class="xs3"><a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>&amp;do=blog&amp;id=<?php echo $blog['blogid'];?>"<?php if($blog['magiccolor']) { ?> class="magiccolor<?php echo $blog['magiccolor'];?>"<?php } ?> target="_blank"><?php echo $blog['subject'];?></a></h3>
<p class="xg1"><?php echo $blog['replynum'];?> 个评论 - <?php echo $blog['viewnum'];?> 次查看 - <?php echo $blog['hot'];?> 热度</p>
<p><?php echo $blog['message'];?></p>
<p>
<span><?php echo $blog['dateline'];?></span>
 -
<span><a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>" target="_blank"><?php echo $blog['username'];?></a></span>
</p>
</li>
<?php } ?>
</ul>
...
<?php if(!empty($_G['setting']['pluginhooks']['blog_bottom'])) echo $_G['setting']['pluginhooks']['blog_bottom'];?><?php $focusid = getfocus_rand($_G[basescript]);?><?php if($focusid !== null) { $focus = $_G['cache']['focus']['data'][$focusid];?><div class="focus" id="focus">
<div class="bm">
<div class="bm_h cl">
